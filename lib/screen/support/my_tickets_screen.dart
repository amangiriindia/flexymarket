  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: const Icon(Icons.add, semanticLabel: 'Create New Ticket',color: AppColors.white,),
      ),
      body: SafeArea(
        child: Stack(
          children: [
        ...
        children: [
          Container(
            ...
            child: DropdownButton<String>(
              ...
              items:
                  _statusFilters.map((String status) {
              ...
              onChanged: (String? newValue) {
                if (newValue != null) {
                  ...
                  _fetchTickets();
                  _showSnackBar(
                    'Status filter changed to $newValue',
                    AppColors.green,
                  );
                }
              },
          ...
          children: [
            ...
            Align(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(Icons.visibility, size: 16.sp,color: AppColors.white,),
                label: Text('View', style: TextStyle(fontSize: 13.sp,color: AppColors.white)),
              ),
            ),
          ],
        ),
