...
class MetaWithdrawScreen extends StatefulWidget {
  final String mt5Login;
  final double availableBalance;

  const MetaWithdrawScreen({
    super.key,
  ...
  @override
  State<MetaWithdrawScreen> createState() => _MetaWithdrawScreenState();
}

class _MetaWithdrawScreenState extends State<MetaWithdrawScreen> {
  ...
  Future<void> _submitWithdrawal() async {
    ...
    final result = await _metaTradeService.withdrawMT5Account(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          result['success'] ? 'Withdrawal successful' : result['message'] ?? 'Withdrawal failed',
          style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonAppBar(
        title: 'Withdraw from MT5 Account',
        showBackButton: true,
